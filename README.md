...
- This README — contract setup, deploy, wire, send, and chapter order
- [`RUNBOOK.md`](RUNBOOK.md) — frontend env, relayer, and operational checks
- [`docs/simple-workers/SIMPLE_WORKERS_GUIDE.md`](docs/simple-workers/SIMPLE_WORKERS_GUIDE.md) — mock DVN/Executor recovery on testnet
