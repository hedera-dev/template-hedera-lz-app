...
task(
    ...
    .addOptionalParam('dstContractName', 'Name of the destination chain OFT in deployments', 'MyAssetOFT', types.string)
    ...
    .setAction(async (args: ProcessReceiveTaskArgs, hre: HardhatRuntimeEnvironment) => {
        ...
        const dstOappDep = await hre.deployments.get(args.dstContractName || 'MyAssetOFT')
